        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
          ...
          <div className="md:col-span-1 m-4 ">
            ...
            <h3 className="text-1xl text-[#FFFF]">
              I am a graduating student from the University of Makati, pursuing
              a Bachelor of Science in Computer Science with a major in
              Application Development. My academic journey has equipped me with
              a strong foundation in software development, and I am eager to
              transition into the software industry upon graduation. My passion
              lies in creating innovative solutions, particularly within the
              realm of front-end development. I
            </h3>

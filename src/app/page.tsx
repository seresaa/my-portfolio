...
const ContactMe = () => {
  ...
  return (
    <a href={`mailto:${emailAddress}`}>
      <button className="px-6 py-2 bg-primary rounded-md text-white">Contact me</button>
    </a>
  );
};
...
export default function Homepage() {
  ...
  return (
    <motion.div className="w-full h-screen" initial="hidden" animate="visible" variants={containerVariants}>
      <div className="flex flex-col items-center mt-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg-grid-cols-2 items-center">
          <motion.div className="md:col-span-1 flex items-center" variants={containerVariants}>
            <div className="m-6">
              <h2 className="text-white text-[20px] col-span-3 ">Hello world, I am Cherry</h2>
          ...
          <motion.div className="md:col-span-1 flex flex-col items-center" variants={containerVariants}>
